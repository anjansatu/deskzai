(function ($) {
    ...
    var allTicketsAdminTableSerch
    $(document).on('input', '#allTicketsAdminDataTableSearch', function () {
        allTicketsAdminTableSerch.search($(this).val()).draw();
    });
    allTicketsAdminTableSerch =  $('#ticketManagementDataTable').DataTable({
        pageLength: 25,
        ordering: false,
        serverSide: true,
        processing: true,
