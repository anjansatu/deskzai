...
(function ($) {
    "use strict";
    var languageAdminTableSerch
    $(document).on('input', '#languageAdminDatatableSearch', function () {
        languageAdminTableSerch.search($(this).val()).draw();
    });
    languageAdminTableSerch =  $('#commonDataTable').DataTable({
        pageLength: 25,
        ordering: false,
        serverSide: true,
        processing: true,
