...
(function ($) {
    "use strict";
    var countrySettingTableSerch
    $(document).on('input', '#countrySettingAdminTableSearch', function () {
        countrySettingTableSerch.search($(this).val()).draw();
    });
    countrySettingTableSerch =  $('#commonDataTable').DataTable({
        pageLength: 25,
        ordering: false,
        serverSide: true,
        processing: true,
