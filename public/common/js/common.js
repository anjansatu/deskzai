    ...
    function getEditModal(url, modalId) {
        $.ajax({
            ...
            success: function (data) {
                ...
                if($('.js-example-basic-multiple-edit').length) {
    ...
    function commonResponseForModal(response) {
        ...
        if (response['status'] === true) {
            ...
            if ($(document).find('form.reset').length) {
                ...
                // Reset Summernote content if present
                if ($(".summernoteOne").length) {
                    $(".summernoteOne").each(function () {
                        $(this).summernote('reset'); // Reset content
                    });
                }
            }
