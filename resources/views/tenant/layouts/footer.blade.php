    ...
    <div class="container">
                ...
                <div class="row rg-20">
                    <div class="col-lg-4 col-md-6">
                        <div class="max-w-366">
                            ...
                            <ul class="list-style-reset d-flex align-items-center g-12 landing-footer-social">
                                <li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="pl-xl-70">
                            ...
                            <ul class="list-style-reset zList-pb-21">
        ...
        <div class="landing-footer-bottom">
            <p class="fs-16 fw-400 lh-22 text-title-black">{{ getGeneralSettingData(getUserIdByTenant(),'app_copyright') }}
                {{ __('By') }}
                <a href="{{ route('frontend') }}" class="link text-decoration-underline">{{ getGeneralSettingData(getUserIdByTenant(),'app_developed') }}</a>
            </p>
        </div>
