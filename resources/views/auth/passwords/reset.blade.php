        ...
        <div class="left">
            <div class="wrap">
                <div class="zMain-signLog-content">
                    ...
                    <h4 class="fs-32 fw-600 lh-48 text-title-black pb-24">{{ __('Reset Password') }}?</h4>
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <button type="submit"
                                class="border-0 d-flex justify-content-center align-items-center w-100 p-15 bd-ra-10 bg-main-color fs-14 fw-500 lh-20 text-white">{{ __('Update') }}</button>
                    </form>
                </div>
            </div>
        </div>
        <div class="right"
             data-background="{{ getFileUrl(getGeneralSettingData(getUserIdByTenant(),'login_left_image')) }}"></div>
    </div>
@endsection
