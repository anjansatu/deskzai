...
<div class="register-area">
    <div class="register-wrap">
        <div class="register-left section-bg-img" data-background="{{ asset('assets/images/auth-img-bg.png') }}">
            <div class="register-left-wrap">
                ...
                <h2 class="fs-36 fw-600 lh-34 text-white pb-8">{{ getOption('auth_page_title') }}</h2>
                <p class="fs-16 fw-400 lh-24 text-white">{{ getOption('auth_page_title') }}</p>
            </div>
        </div>
        <div class="register-right">
            <div class="primary-form">
                <!-- Title -->
                <div class="pb-40">
                    <h2 class="fs-32 fw-600 lh-38 text-title-black pb-3">{{ __('Confirm Email') }}</h2>
                ...
                <form action="{{ route('email.verified', $token) }}" method="POST" class="otp-form" name="otp-form">
                    ...
                    <div class="d-none" id="resent-div">
                        <button type="button"
                                ...
                                class="align-items-center bd-ra-12 border-0 d-flex fs-15 fw-500 hover-bg-one justify-content-center lh-20 bg-cdef84  mb-18 mt-30 p-2 pt-10 text-title-black w-100 w-full"
                                title="{{ __('Click here to request another') }}">{{ __('Click here to request another')
                            }}</button>
                    </div>
                    <button id="verify-btn" type="submit"
                            class="d-flex justify-content-center align-items-center w-100 border-0 fs-15 fw-500 lh-25 text-title-black p-13 bd-ra-12 bg-cdef84 hover-bg-one">{{
                        __('Verify') }}</button>
                </form>
