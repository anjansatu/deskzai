    ...
    <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
        ...
        <form action="{{route('customer.ticket.submit')}}" method="post" class="form-horizontal"
            ...
            <div class="row rg-24">
                ...
                <div class="col-md-6">
                    <div class="user-info-from">
                        <label class="zForm-label">{{__("Category")}} <span>*</span></label>
                        <select id="" class="zForm-control" name="category">
                ...
                @if($envato?->enable_purchase_code == 1)
                    <div class="col-md-6">
                        <div class="user-info-from">
                            ...
                            <input type="text" placeholder="8c3b8f37-34bd-4d4c-71da-331abb35ecc9" class="zForm-control"
                                   name="purchase_code">
                        </div>
                    </div>
                    <div class="col-md-6">
                            ...
                            <div class="zi-lg-w-100" style="width: {{$field->width != null?$field->width:100}}%;">
                                <div class="user-info-from">
                                    @if($field->type == TEXT_FIELD_ID)
                                        <label class="zForm-label">{{$field->level}}
                                            <span>{{$field->required == REQUIRED_YES?'*':''}}</span></label>
                                        <input type="text" placeholder="{{$field->placeholder}}" class="zForm-control"
                                               name="{{$field->name}}">
                                    @elseif($field->type == TEXTAREA_FIELD_ID)
                                        <label class="zForm-label">{{$field->level}}
                                            <span> {{$field->required == REQUIRED_YES?'*':''}}</span></label>
                                        <textarea class="zForm-control mb-3 text-h" placeholder="{{$field->placeholder}}"
                ...
                <div class="col-md-12">
                    <div class="user-info-from">
                        ...
                        <textarea class="zForm-control" placeholder="Massage"
            ...
            <div class="agree-box align-items-start">
                <div class="agree-left zForm-wrap-checkbox">
                    ...
                    <label for="service"> {{__("I agree with")}} </label> <a href=""
                                                                             class="text-main-color text-decoration-underline">{{__("Terms & Service")}}</a>
                </div>
                <button id="submit-btn" class="border-0 bg-main-color py-8 px-26 bd-ra-8 fs-15 fw-600 lh-25 text-white mt-25"
