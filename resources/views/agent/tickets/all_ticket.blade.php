...
@section('content')
    ...
    <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
        ...
        <div
            ...
            <div class="flex-grow-1 max-w-282">
                <div class="search-one flex-grow-1">
                    <input type="text" id="ticketsAgentDataTableSearch" placeholder="{{__('Search here')}}..."/>
                    <button class="icon">
        ...
        {{--                            <div class="zTab-one-wrap">--}}
        {{--                                <ul class="nav nav-tabs zTab-reset zTab-one" id="ticketTab" role="tablist">--}}
        {{--                                    <li class="nav-item" role="presentation">--}}
        {{--                                        <button--}}
        {{--                                            class="border nav-link ticketCategoryStatusTab active text-title-black ticketCategoryId"--}}
        {{--                                            data-bs-toggle="tab" data-bs-target="#allTabPane"--}}
        {{--                                            type="button" data-status="All" role="tab" aria-controls="allTabPane"--}}
        {{--                                            aria-selected="true" value="All">{{ __('All') }}--}}
        {{--                                        </button>--}}
        {{--                                    </li>--}}
        {{--                                    @foreach($ticketCategory as $data)--}}
        {{--                                        <li class="nav-item" role="presentation">--}}
        {{--                                            <button--}}
        {{--                                                class="border nav-link ticketCategoryStatusTab text-title-black ticketCategoryId"--}}
        {{--                                                data-bs-toggle="tab" data-bs-target="#allTabPane"--}}
        {{--                                                type="button" data-status="All" role="tab" aria-controls="allTabPane"--}}
        {{--                                                value="{{ $data->id }}"--}}
        {{--                                                aria-selected="true">{{ $data->name }}--}}
        {{--                                            </button>--}}
        {{--                                        </li>--}}
        {{--                                    @endforeach--}}
        {{--                                </ul>--}}
            ...
            <form action="{{route('agent.ticket.ticket-multi-delete')}}" method="post"
                ...
                <table class="table zTable zTable-last-item-right" id="ticketsDataTable">
                    ...
                    <tr>
                        ...
                        <th>
                            <div>{{ __('Ticket Title') }}</div>
                        </th>
                        <th>
                            <div>{{ __('Created By') }}</div>
                        </th>
                        <th>
                            <div>{{ __('Created By Email') }}</div>
                        </th>
                        <th>
                            <div>{{ __('Category') }}</div>
                        </th>
