...
@section('content')
    ...
    <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
        ...
        <!-- Create Ticket start-->
        <form action="{{route('agent.ticket.submit')}}" method="post" class="form-horizontal"
            ...
            <div class="row rg-24">
                ...
                <div class="col-md-6">
                    <div class="user-info-from">
                        ...
                        <select id="" class="single-catagories zForm-control" name="category">
                            ...
                            <div class="zi-lg-w-100" style="width: {{$field->width != null?$field->width:100}}%;">
                                <div class="user-info-from">
                                    ...
                                    @elseif($field->type == TEXTAREA_FIELD_ID)
                                        <label class="zForm-label">{{$field->level}}
                                            <span> {{$field->required == REQUIRED_YES?'*':''}}</span></label>
                                        <textarea class="zForm-control mb-3 text-h"
                ...
                <div class="col-md-12">
                    <div class="user-info-from">
                        ...
                        <textarea class="customer-ticket-create summernoteOne" placeholder="Massage"
            ...
            <div class="agree-box align-items-start">
                <div class="agree-left zForm-wrap-checkbox">
                    ...
                    <label for="service"> {{__("I agree with")}} <a href="#"
                                                                    class="text-main-color text-decoration-underline">{{__("Terms & Service")}}</a></label>
                </div>
                <button class="submit-btu border-0 bg-main-color py-8 px-26 bd-ra-8 fs-15 fw-600 lh-25 text-white mt-25" disabled="disabled">{{__("Create Ticket")}}</button>
            </div>
        </form>
