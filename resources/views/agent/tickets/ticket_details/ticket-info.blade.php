    ...
    <ul class="zList-pb-16">
        ...
        <li>
            <div class="d-flex justify-content-between align-items-start g-10">
                ...
                <button type="button" class="p-8 d-flex align-items-center g-12 bg-main-color bd-one bd-c-main-color bd-ra-8" data-bs-toggle="modal" data-bs-target="#categorymodel">
        ...
        <li>
            <div class="d-flex justify-content-between align-items-start g-10">
                ...
                <button type="button" class="p-8 d-flex align-items-center g-12 bg-main-color bd-one bd-c-main-color bd-ra-8" data-bs-toggle="modal" data-bs-target="#prioritymodel">
                    <img src="{{asset('main_assets/images/icon/edit.svg')}}" alt="">
                </button>
            </div>
        </li>
