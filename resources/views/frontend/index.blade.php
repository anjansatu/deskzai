...
@section('content')
                        ...
                        <div class="hero-text">
                            ...
                            <div class="d-flex justify-content-center align-items-center column-gap-3 row-gap-3">
                                @if (isAddonInstalled('DESKSAAS') > 0)
                                    <a href="{{route('pricing')}}" class="down-btu-2 ">{{__('Pricing')}}</a>
                                @endif
                                <a href="{{route('login')}}" class="down-btu-3 ">{{__('Get Started')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @if($section['testimonial_area'] != null && $section['testimonial_area']->status==STATUS_ACTIVE)
        <section class="user-area sf-pt-0">
            <!-- title area start -->
