            ...
            <form action="{{route('admin.user.store')}}" method="post" class="form-horizontal"
                ...
                <div class="row rg-24">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" id="name" value="{{old('name')}}" placeholder="{{__('Name')}}"
                               class="zForm-control">
                        @if ($errors->has('name'))
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="mobile" id="contact_number" value="{{old('mobile')}}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="email" id="email" value="{{old('email')}}"
                               placeholder="{{__('Email')}}" class="zForm-control">
                        @if ($errors->has('email'))
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="zForm-label" for="password">{{__('Password')}} <span class="text-danger">*</span></label>
                        <input type="password" name="password" id="password" value="" placeholder="{{__('Password')}}"
                               class="zForm-control">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="zForm-label" for="gender">{{__('Gender')}} <span
                                class="text-danger">*</span></label>
                        <select name="gender" id="gender" class="sf-select-without-search">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="phone_verification_status" id="phone_verification_status"
                                class="sf-select-without-search">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="zForm-label" for="email_verification_status">{{__('Email Verification')}} <span
                                class="text-danger">*</span></label>
                        <select name="email_verification_status" id="email_verification_status"
                                class="sf-select-without-search">
                            <option value="0">{{ __('No') }}</option>
                            <option value="1">{{ __('Yes') }}</option>
                        ...
                        @if(auth()->user()->role == USER_ROLE_ADMIN && auth()->user()->tenant_id != null)
                            <div class="col-md-6">
                                ...
                                <label class="zForm-label" for="user_role">{{__('User Role')}} <span
                                        class="text-danger">*</span></label>
                                <select name="user_role" id="user_role" class="sf-select-without-search">
