<div data-aos="fade-down" data-aos-duration="1000" class="main-header">
    ...
    <div class="d-flex align-items-center cg-15">
        ...
        <a href="{{ route('frontend') }}" target="_blank"
           class="border-0 bg-main-color py-8 px-26 bd-ra-8 fs-15 fw-600 lh-25 text-white d-none d-sm-inline-flex align-items-center g-10">
            {{__('Visit Site')}}
            <span class="iconify" data-icon="material-symbols:arrow-outward-rounded"></span>
        </a>
        <div class="d-sm-none">
            <a href="{{ route('frontend') }}" target="_blank"
               class="d-flex justify-content-center align-items-center w-41 h-41 bd-one bd-c-main-color rounded-circle bg-main-color">
                <img class="max-w-19" src="{{ asset('main_assets/images/icon/visit-site.svg') }}" alt="Visit Site">
            </a>
        </div>
    </div>
    <!-- Right -->
            ...
            <ul class="dropdown-menu dropdownItem-one">
                ...
                <li>
                    <a class="d-flex align-items-center cg-8" href="{{ route('admin.profile.change-password') }}">
                        ...
                        <p class="fs-14 fw-500 lh-17 text-para-text text-nowrap">{{__("Change Password")}}</p>
                    </a>
                </li>
                <li>
