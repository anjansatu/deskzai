        ...
        @csrf
            ...
            <div class="row rg-24">
                <div class="col-12">
                    ...
                    <input class="zForm-control" type="text" name="title" placeholder="{{ __('Category') }}" value="{{$knowledgeCategory->title}}">
                </div>
                <div class="col-12">
                    <label class="zForm-label" for="title">{{ __('Description') }} <span class="text-danger">*</span></label>
                    <input class="zForm-control" type="text" name="description" placeholder="{{ __('Description') }}" value="{{$knowledgeCategory->description}}">
                </div>
                <div class="col-12">
