    ...
    <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
        <div class="row">
            <input type="hidden" id="news-list-route"
                   value="{{ route('admin.setting.frontend.knowledge-category.index') }}">
            <div class="col-xl-3">
                    ...
                    <div
                        ...
                        <div class="flex-grow-1">
                            <div class="search-one flex-grow-1 max-w-282">
                                <input type="text" id="knowledgeCategorySearch" placeholder="{{__('Search here')}}..."/>
                                <button class="icon">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        ...
                                        <path d="M18.3574 18.3571L13.8574 13.8571" stroke="#707070"
                                              stroke-width="1.35902"
                                              stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </button>
                            </div>
                        </div>
                        <button class="d-inline-flex bd-ra-8 bg-main-color py-8 px-26 fs-15 fw-600 lh-25 text-white"
                                type="button" data-bs-toggle="modal" data-bs-target="#add-modal">
                            {{ __('+ Add New') }}
                        </button>
                    </div>
                    <table class="table zTable zTable-last-item-right" id="knowledgeCategoryDataTable">
                        <thead>
                        <tr>
                            <th>
                                <div>{{ __('Category') }}</div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content bd-c-stroke bd-one bd-ra-10">
                    <div class="p-sm-25 p-15">
                        ...
                        <form class="ajax reset" action="{{ route('admin.setting.frontend.knowledge-category.store') }}"
                              method="post"
                            ...
                            <div class="row rg-24">
                                <div class="col-12">
                                    <label class="zForm-label">{{ __('Category') }}</label>
                                    <input type="text" name="title" class="zForm-control"
                                           placeholder="{{ __('Category') }}">
                                </div>
                                <div class="col-12">
                                    <label class="zForm-label">{{ __('Description') }}</label>
                                    <input type="text" name="description" class="zForm-control"
