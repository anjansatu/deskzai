...
@section('content')
    ...
    <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
        ...
        <div
            ...
            <div class="flex-grow-1 max-w-282">
                <div class="search-one flex-grow-1">
                    <input type="text" id="selfAssignedTicketsDataTableSearch" placeholder="{{__('Search here')}}..."/>
                    <button class="icon">
        ...
        <div class="p-sm-25 p-15 bd-one bd-c-stroke bd-ra-10 bg-white">
            ...
            <table class="table zTable zTable-last-item-right" id="selfAssignedTickets">
                <thead>
                <tr>
                    <th>
