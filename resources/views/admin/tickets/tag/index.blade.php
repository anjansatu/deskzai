...
@section('content')
    ...
    <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
        ...
        <div
            ...
            <div class="flex-grow-1">
                <div class="search-one flex-grow-1 max-w-282">
                    <input type="text" id="tagListDatatableSearch" placeholder="{{__('Search here')}}..."/>
                    <button class="icon">
        ...
        <div class="p-sm-25 p-15 bd-one bd-c-stroke bd-ra-10 bg-white">
            ...
            <table class="table zTable zTable-last-item-right" id="ticketTagsDataTable">
                <thead>
                <tr>
                    <th>
                        <div>{{ __('Name') }}</div>
            ...
            <div class="modal-content bd-c-stroke bd-one bd-ra-10">
                <div class="p-sm-25 p-15">
                    <div
                        ...
                        <button type="button" class="sf-modal-close-btn" data-bs-dismiss="modal" aria-label="Close"><i
                    ...
                    <form class="ajax reset" action="{{ route('admin.tickets.tag-store') }}" method="post"
                        ...
                        <div class="row rg-24">
                            <div class="col-12">
                                <label class="zForm-label" for="title">{{ __('Name') }} <span
                                        class="text-danger">*</span></label>
                                <input class="zForm-control" required type="text" name="name"
                                       placeholder="{{ __('Name') }}">
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <select name="group_user[]" class="form-control js-example-basic-multiple"
                                    ...
                                    @foreach($userList as $user)
                                        <option
                                            value="{{$user->id}}">{{ $user->email.'('.getRoleName(USER_ROLE_AGENT).')' }}</option>
                                    @endforeach
                                </select>
                            </div>
