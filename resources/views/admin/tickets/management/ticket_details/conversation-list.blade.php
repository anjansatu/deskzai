...
@foreach($conversationData as $conversation)
    <div class="p-sm-25 p-15 bd-one bd-c-stroke bd-ra-10 bg-white">
        <div class="
            @if($conversation->user->role == USER_ROLE_ADMIN) admin
            @elseif($conversation->user->role == USER_ROLE_AGENT) maintainer
            @else customer
         @endif ">
                ...
                <div class="d-flex justify-content-between align-items-center bd-b-one bd-c-stroke pb-17 mb-17 fs-18 fw-600 lh-22 text-title-black">
                    ...
                    <div class="d-flex flex-sm-row flex-column-reverse align-items-end align-items-sm-center g-10">
                        ...
                        <div class="dropdown {{$conversation->user->role == USER_ROLE_CUSTOMER?'d-none':''}}">
                            <button
                                class="dropdown-toggle conversion-list-dropdown-toggle flex-shrink-0 p-0 bg-transparent w-30 h-30 ms-auto bd-one bd-c-stroke rounded-circle d-flex justify-content-center align-items-center fs-13 text-para-text"
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <button
                                        class="border-0 bg-transparent p-0 w-100 text-start d-flex align-items-center cg-8 edit-modal-action"
                                        data-content="{{$conversation->body}}" data-id="{{$conversation->id}}">
                                        <div class="d-flex">
                                ...
                                <li>
                                    <button
                                        class="border-0 bg-transparent p-0 w-100 text-start d-flex align-items-center cg-8 delete-action"
