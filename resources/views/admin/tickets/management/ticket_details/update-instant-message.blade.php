<form action="{{route('admin.conversations.instantMessage')}}" method="post" class="ajax form-horizontal"
      enctype="multipart/form-data" data-handler="commonResponseForModal">
    @csrf
    <div class="modal fade" id="InstantModalEdit" tabindex="-2" aria-labelledby="InstantModalEditLabel"
         aria-hidden="true">
                ...
                <div class="p-sm-25 p-15">
                    ...
                    <div class="row rg-24">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" placeholder="{{__('Title')}}" name="title" id="title"
                                   class="ir-title zForm-control">
                        </div>
                        <div class="col-12">
                            <label class="zForm-label">{{__('Message:')}}</label>
                            <textarea name="message" id="message" class="zForm-control ir-msg"
                    ...
                    <div class="d-flex justify-content-center justify-content-sm-start flex-wrap g-14 pt-25">
                        ...
                        <button type="submit"
                                ...
                                id="InstantModalEditButtonEdit">{{__('Update Reply')}}</button>
                    </div>
