...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <input type="hidden" id="ticket-list-route"
                       value="{{route('admin.tickets.my-ticket-history',['id'=>$my_id])}}">
                <div class="col-xl-12">
                    <div class="email-inbox__area bg-style form-horizontal__item bg-style admin-general-settings-page">
                        ...
                        <div class="customers__table">
                            <table
                                class="row-border table-style common-datatable responsive dataTable no-footer dtr-inline ZaideskTable"
