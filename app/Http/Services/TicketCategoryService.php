        ...
        return datatables($blogCategory)
            ...
            ->editColumn('is_ticket_prefix', function ($data) {
                if ($data->is_ticket_prefix == 1) {
                    return '<span class="zBadge zBadge-active">True</span>';
                } else {
                    return '<span class="zBadge zBadge-deactivate">False</span>';
                }
            })->addColumn('status', function ($data) {
                if ($data->status == 1) {
                    return '<span class="zBadge zBadge-active">Active</span>';
                } else {
                    return '<span class="zBadge zBadge-deactivate">Deactivate</span>';
                }
            })
