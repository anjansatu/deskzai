...
class   TicketsController extends Controller
{
    ...
    public function createTicket()
    {
        ...
        $data['activeCreateTicket'] = 'active';
    ...
    public function activeTicket(Request $request)
    {
        ...
        $data['showTicket'] = 'show';
        $data['activeActiveTicket'] = 'active';
    ...
    public function recentTicket(Request $request)
    {
        ...
        $data['navMain'] = 'mm-active';
        $data['showTicket'] = 'show';
        $data['activeRecentTicket'] = 'active';
    ...
    public function allTicket(Request $request)
    {
        ...
        $data['showTicket'] = 'show';
        $data['activeAllTickets'] = 'active';
        $data['targetDataUrl'] = route('agent.ticket.all-ticket');
        $data['ticketCategory'] = Category::where('status', STATUS_ACTIVE)->get();
    ...
    public function suspendTicket(Request $request)
    {
        ...
        $data['navMain'] = 'mm-active';
        $data['showTicket'] = 'show';
        $data['activeSuspendedTicket'] = 'active';
    ...
    public function myAssignedTicket(Request $request)
    {
        ...
        $data['navMain'] = 'mm-active';
        $data['showTicket'] = 'show';
        $data['activeMyAssignedTicket'] = 'active';
    ...
    public function resolvedTicketList(Request $request)
    {
        ...
        $data['navMain'] = 'mm-active';
        $data['showTicket'] = 'show';
        $data['activeResolvedTicket'] = 'active';
    ...
    public function onHoldTickets(Request $request)
    {
        ...
        $data['navMain'] = 'mm-active';
        $data['showTicket'] = 'show';
        $data['activeOnHoldTicket'] = 'active';
    ...
    public function closedTickets(Request $request)
    {
        ...
        $data['navMain'] = 'mm-active';
        $data['showTicket'] = 'show';
        $data['activeClosedTicket'] = 'active';
    ...
    public function deleteTicketList(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $data['navMain'] = 'mm-active';
            $data['showTicket'] = 'show';
            $data['activeDeleteTicket'] = 'active';
...
//        $data['ticketUserData'] = getTicketAssignedAgentArray($id);
        ...
        if (isset($data['envatoConfigData']->envato_expired_on) && $data['envatoConfigData']->envato_expired_on == STATUS_ACTIVE) {
            ...
            if(is_null($getData)){
                ...
                $getData = new TicketLicenseVerify();
                $getData->ticket_id = $id;
                $getData->response_json = $responseData['status'] == true? json_encode($responseData['data']):null;
                $getData->verified_at = $responseData['status'] == true ? now() : null;
                $getData->save();
            }elseif ($getData->verified_at == null || Carbon::now()->diffInDays(Carbon::parse($getData->verified_at)) >= 1){
                $responseData = $this->envatoService->licenseVerificationForTicket($data['ticketData']);
                $getData->response_json = $responseData['status'] == true? json_encode($responseData['data']):null;
                $getData->verified_at = $responseData['status'] == true ? now() : null;
                $getData->save();
            ...
            $responseData = json_decode($getData?->response_json);
